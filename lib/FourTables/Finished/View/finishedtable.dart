...
class Finishedtable extends StatelessWidget {
  final bool initialValue;
  final Function(bool?)? onChanged;
  final ScrollController _verticalController = ScrollController();
  final ScrollController _horizontalController = ScrollController();
  final controller2 = Get.find<Finishedcontroller>();

  Finishedtable({Key? key, this.initialValue = false, this.onChanged})
    : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(Finishedcontroller());
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              return Container(
                ...
                height: controller.tableRows.length * 80,
  ...
  Widget _buildSortableHeaderCell(String title, Finishedcontroller controller) {
    return Container(
      width: _getColumnWidth(title),
      height: 60,
      padding: const EdgeInsets.all(8),
