...
class Finishedtable extends StatefulWidget {
  final bool initialValue;
  final Function(bool?)? onChanged;

  const Finishedtable({Key? key, this.initialValue = false, this.onChanged})
    : super(key: key);

  @override
  FinishedtableState createState() => FinishedtableState();
}

class FinishedtableState extends State<Finishedtable> {
  ...
  void initState() {
    ...
    tableRows.addAll([
      TableRowData(
        ...
        testDate: '2025-08-20',
        clientDeliveryStatus: 'تم التسليم',
    ...
    print('Finished Table rows count: ${tableRows.length}');
  }
    ...
    return Container(
      ...
      child: Transform.translate(
        ...
        child: Checkbox(
          ...
          activeColor: const Color(0xFF8DA5B5),
