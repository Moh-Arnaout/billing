...
class Newtable extends StatelessWidget {
  ...
  final controller2 = Get.find<Newcontroller>();

  Newtable({Key? key, this.initialValue = false, this.onChanged})
    : super(key: key);
  ...
  Widget _buildSortableHeaderCell(String title, Newcontroller controller) {
    return Container(
      width: _getColumnWidth(title),
      height: 60,
      padding: const EdgeInsets.all(8),
